...
_COMPOSITION_RULE_NO_NAME = (
    ...
    "inside the bounding box above intact, render the pet a touch smaller. "
    "Never push features off any edge.\n"
    "- ABSOLUTELY ZERO TEXT ANYWHERE IN THE IMAGE. This rule is "
    "non-negotiable and overrides any conventional expectations from the "
    "reference photo. NO letters, NO numbers, NO words, NO names, NO "
    "monograms, NO watermarks, NO signatures, NO logos, NO brand marks. "
    "Specifically — and this is where models routinely fail — collar tags, "
    "ID tags, name plates, engraved bands, embroidered patches, dog-tag "
    "metalwork, breed plaques, nameplates on furniture or props, signage "
    "on backgrounds, book spines, shop signs, banners, scrolls, ribbons, "
    "and any accessory the pet is wearing must render BLANK, smooth, and "
    "unmarked. If the reference photo shows a collar with a tag, paint a "
    "plain unmarked tag (or no tag at all). If the reference photo "
    "includes text, omit it entirely. Treat any temptation to add "
    "text-like marks as a hard error and render only abstract texture "
    "instead. The breathing room above the pet stays as quiet, unbroken "
    "background.\n"
    "- NO RESERVED BANDS OR PANELS: never output a solid colour bar, empty "
    "rectangle, letterbox stripe, or framed panel at the top or bottom. "
